...
import { HistoriqueResponse, DemandeConge } from '../../../core/models/conge.model';
...
export class HistoriqueListComponent implements OnInit {
  ...
  filterStatus = 'ALL'; // 'ALL', 'LATE', 'ON_TIME'
